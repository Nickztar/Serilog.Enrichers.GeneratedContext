...
A [Serilog](https://serilog.net) and ILogger source generator that supports enriching logs with which method called them.
...
Create a class or extend your current class
